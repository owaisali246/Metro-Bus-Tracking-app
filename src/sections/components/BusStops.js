...
export const stopsList = ['Surjani Town', '4K Chowrangi', 'PowerHouse Chowrangi', 'U.P. More', 'Nagan Chowrangi', 'Sakhi Hassan Chowrangi', '5-Star Chowrangi', 'KDA Chowrangi', 'Board Office Stop', 'Nazimabad 7 Number Stop', 'Nazimabad Petrol Pump Stop', 'Golimar Chowrangi', 'Gulbahar Stop', 'Lasbela Chowk', 'Guru Mandir Chowrangi', 'Numiash Chowrangi']
export const stopsCollection = [
  ...
  { name: 'U.P. More', coord: { lat: 24.9727, lng: 67.06633 } },
  { name: 'Nagan Chowrangi', coord: { lat: 24.9654, lng: 67.06689 } },
